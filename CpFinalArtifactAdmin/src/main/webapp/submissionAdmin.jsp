          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                                                <%
                                                	Iterator<org.bson.Document> cursor = (Iterator<org.bson.Document>) DAO.getAllSubmissions();
                  ...
                  <td ><i class="fas fa-memory">&nbsp; </i><%=  memoryResult %> </td>
                  <td ><i class="fas fa-clock">&nbsp; </i><%= timeResult %></td>

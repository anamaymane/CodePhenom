...
<div class="content-wrapper" style="margin-bottom: 54px">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Submissions in the problem :  <%=(String)request.getAttribute("id")%></h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="./">Home</a></li>
						<li class="breadcrumb-item " ><a href="./problemSet?display=all">problems</a></li>
						<li class="breadcrumb-item active " > problem Submission</li>
                ...
                <tbody>
                                                <%
                                                	Iterator<org.bson.Document> cursor = (Iterator<org.bson.Document>)
                                                							DAO.getSubmissionsPerProblem((String)request.getAttribute("id"));
